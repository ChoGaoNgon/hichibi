# Technical Flow Documentation - The Coffee House Clone
...
5.  **Hoàn tất**: Xóa giỏ hàng (`cartStore.clearCart()`) và hiển thị màn hình thành công.
...
## 4. Hệ thống Phân quyền (Security & Authorization)
